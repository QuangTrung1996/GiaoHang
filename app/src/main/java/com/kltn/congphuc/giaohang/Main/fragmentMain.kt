...
class fragmentMain: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        pagerAdapter = fragmentMainPagerAdapter(this.activity.supportFragmentManager)
        pagerAdapter!!.addfragment(fragmentHome.newInstance("home"),"tab1")
        pagerAdapter!!.addfragment(fragmentTransportFee.newInstance("monney"),"tab2")
        pagerAdapter!!.addfragment(fragmentGoodsReceived.newInstance("goods"),"tab3")
        pagerAdapter!!.addfragment(fragmentMap.newInstance("map"),"tab4")
